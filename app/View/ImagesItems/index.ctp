<div class="imagesItems index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $imagesItem['ImagesItem']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $imagesItem['ImagesItem']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $imagesItem['ImagesItem']['id']), null, __('Are you sure you want to delete # %s?', $imagesItem['ImagesItem']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
